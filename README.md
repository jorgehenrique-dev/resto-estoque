...
- 🔐 **Login seguro** com autenticação via banco de dados.
- 📊 **Painel com KPIs** — visão rápida do estado do estoque em tempo real.
- ⚠️ **Alertas automáticos** quando ingredientes ficam abaixo do mínimo.
- 📦 **Cadastro completo** de ingredientes com categoria, unidade e estoque mínimo.
